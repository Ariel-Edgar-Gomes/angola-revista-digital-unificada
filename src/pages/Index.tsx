  ...
  return (
    <Layout>
      <section className="py-8 sm:py-10 md:py-16">
        <div className="metodista-container">
          <div className="text-center mb-8 md:mb-12">
            <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-3 text-[#1b1464] animate-fade-in">
              Revista Digital
            </h1>
            <div className="w-24 h-1 mx-auto bg-[#e53935] mb-3"></div>
        ...
        <div className="metodista-container">
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#1b1464]">Artigos Recentes</h2>
            </div>
            <Button variant="outline" className="border-[#1b1464] text-[#1b1464] hover:bg-[#1b1464] hover:text-white transition-colors duration-300" asChild>
      ...
      <section className="py-16 bg-[#f5f5f5] relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#1b1464]/20 to-transparent"></div>
        {/* Decorative elements */}
        <div className="absolute top-20 right-10 w-40 h-40 rounded-full bg-[#e53935]/5 blur-3xl"></div>
      ...
      <section className="py-16 bg-[#1b1464] text-white relative overflow-hidden">
        ...
        <div className="absolute top-10 left-10 w-20 h-20 rounded-full border border-[#e53935]/20"></div>
        <div className="absolute bottom-10 right-10 w-16 h-16 rounded-full border border-[#e53935]/10"></div>
        ...
        <div className="metodista-container text-center relative z-10">
          ...
          <div className="w-24 h-1 mx-auto bg-[#e53935]/50 mb-6"></div>
          ...
          <Button size="lg" asChild className="bg-[#e53935] hover:bg-[#c62828] text-white font-medium px-8 button-shine">
